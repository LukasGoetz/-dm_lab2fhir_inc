...
class Condition(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("abatementPeriod", "abatementPeriod", mii_period.Period, False, "abatement", False),
            ...
            ("category", "category", mii_codeableconcept.CodeableConcept, True, None, False),
            ("clinicalStatus", "clinicalStatus", codeableconcept.CodeableConcept, False, None, True),
            ...
            ("onsetAge", "onsetAge", age.Age, False, "onset", True),
            ("onsetDateTime", "onsetDateTime", fhirdate.FHIRDate, False, "onset", True),
            ("onsetPeriod", "onsetPeriod", mii_period.Period, False, "onset", True),
            ("onsetRange", "onsetRange", range.Range, False, "onset", True),
            ("onsetString", "onsetString", str, False, "onset", True),
            ("recordedDate", "recordedDate", fhirdate.FHIRDate, False, None, True),
            ("recorder", "recorder", fhirreference.FHIRReference, False, None, False),
            ("severity", "severity", mii_codeableconcept.CodeableConcept, False, None, False),
            ("stage", "stage", ConditionStage, True, None, False),
            ("subject", "subject", fhirreference.FHIRReference, False, None, True),
            ("verificationStatus", "verificationStatus", mii_codeableconcept.CodeableConcept, False, None, False),
        ])
        return js
...
class ConditionEvidence(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("code", "code", mii_codeableconcept.CodeableConcept, True, None, False),
...
class ConditionStage(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("summary", "summary", mii_codeableconcept.CodeableConcept, False, None, False),
            ("type", "type", mii_codeableconcept.CodeableConcept, False, None, False),
        ])
        return js
...
try:
    from . import codeableconcept, mii_codeableconcept
except ImportError:
