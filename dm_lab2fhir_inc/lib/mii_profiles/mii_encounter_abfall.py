...
class Encounter(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("class_fhir", "class", mii_coding.Coding, False, None, True),
            ...
            ("location", "location", EncounterLocation, True, None, True),
            ("partOf", "partOf", fhirreference.FHIRReference, False, None, True),
            ("participant", "participant", EncounterParticipant, True, None, False),
            ("period", "period", mii_period.Period, False, None, True),
            ("priority", "priority", mii_codeableconcept.CodeableConcept, False, None, False),
            ("reasonCode", "reasonCode", mii_codeableconcept.CodeableConcept, True, None, False),
            ("reasonReference", "reasonReference", fhirreference.FHIRReference, True, None, False),
            ("serviceProvider", "serviceProvider", fhirreference.FHIRReference, False, None, False),
            ("serviceType", "serviceType", mii_codeableconcept.CodeableConcept, False, None, True),
            ("status", "status", str, False, None, True),
            ("statusHistory", "statusHistory", EncounterStatusHistory, True, None, False),
            ("subject", "subject", fhirreference.FHIRReference, False, None, True),
            ("type", "type", mii_codeableconcept.CodeableConcept, True, None, False),
        ])
        return js
...
class EncounterDiagnosis(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("use", "use", mii_codeableconcept.CodeableConcept, False, None, False),
        ])
        return js
...
class EncounterHospitalization(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("admitSource", "admitSource", mii_codeableconcept.CodeableConcept, False, None, False),
            ("destination", "destination", fhirreference.FHIRReference, False, None, False),
            ("dietPreference", "dietPreference", mii_codeableconcept.CodeableConcept, True, None, False),
            ("dischargeDisposition", "dischargeDisposition", mii_codeableconcept.CodeableConcept, False, None, False),
            ("origin", "origin", fhirreference.FHIRReference, False, None, False),
            ("preAdmissionIdentifier", "preAdmissionIdentifier", mii_identifier.Identifier, False, None, False),
            ("reAdmission", "reAdmission", mii_codeableconcept.CodeableConcept, False, None, False),
            ("specialArrangement", "specialArrangement", mii_codeableconcept.CodeableConcept, True, None, False),
            ("specialCourtesy", "specialCourtesy", mii_codeableconcept.CodeableConcept, True, None, False),
        ])
        return js
...
class EncounterLocation(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("period", "period", mii_period.Period, False, None, True),
            ("physicalType", "physicalType", mii_codeableconcept.CodeableConcept, False, None, False),
            ("status", "status", str, False, None, True),
        ])
        return js
...
class EncounterParticipant(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("period", "period", mii_period.Period, False, None, False),
            ("type", "type", mii_codeableconcept.CodeableConcept, True, None, False),
        ])
        return js
...
import sys
try:
    from . import mii_codeableconcept
except ImportError:
    codeableconcept = sys.modules[__package__ + '.codeableconcept']
try:
    from . import mii_coding
except ImportError:
