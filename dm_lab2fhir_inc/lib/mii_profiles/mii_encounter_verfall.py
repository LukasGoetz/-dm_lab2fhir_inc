...
class Encounter(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("identifier", "identifier", mii_identifier.Identifier, True, None, True),
            ...
            ("serviceType", "serviceType", mii_codeableconcept.CodeableConcept, False, None, False),
...
class EncounterDiagnosis(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("use", "use", mii_codeableconcept.CodeableConcept, False, None, True),
        ])
        return js
