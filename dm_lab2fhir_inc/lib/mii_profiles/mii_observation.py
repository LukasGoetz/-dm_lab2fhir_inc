...
class Observation(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("effectiveInstant", "effectiveInstant", fhirdate.FHIRDate, False, "effective", True),
            ("effectivePeriod", "effectivePeriod", period.Period, False, "effective", True),
            ("effectiveTiming", "effectiveTiming", timing.Timing, False, "effective", True),
            ...
            ("valueCodeableConcept", "valueCodeableConcept", mii_codeableconcept.CodeableConcept, False, "value", True),
            ...
            ("valueQuantity", "valueQuantity", mii_quantity.Quantity, False, "value", True),
...
try:
    from . import quantity, mii_quantity
except ImportError:
