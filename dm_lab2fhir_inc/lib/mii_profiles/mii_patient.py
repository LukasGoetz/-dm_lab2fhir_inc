...
class Patient(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("address", "address", mii_address.Address, False, None, True),
            ("birthDate", "birthDate", fhirdate.FHIRDate, False, None, True),
            ...
            ("identifier", "identifier", mii_identifier_pat.Identifier, True, None, True),
            ...
            ("name", "name", mii_humanname.HumanName, True, None, True),
...
class PatientLink(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("other", "other", fhirreference.FHIRReference, True, None, False),
...
try:
    from . import mii_humanname, humanname
except ImportError:
    humanname = sys.modules[__package__ + '.humanname']
try:
    from . import mii_identifier_pat
except ImportError:
