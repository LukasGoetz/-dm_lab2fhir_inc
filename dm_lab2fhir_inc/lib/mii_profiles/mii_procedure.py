...
class Procedure(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("bodySite", "bodySite", mii_codeableconcept.CodeableConcept, True, None, False),
            ("category", "category", mii_codeableconcept.CodeableConcept, False, None, True),
            ("code", "code", mii_codeableconcept.CodeableConcept, False, None, True),
            ("complication", "complication", mii_codeableconcept.CodeableConcept, True, None, False),
            ...
            ("followUp", "followUp", mii_codeableconcept.CodeableConcept, True, None, False),
            ("identifier", "identifier", identifier.Identifier, True, None, False),
            ("instantiatesCanonical", "instantiatesCanonical", str, True, None, False),
            ("instantiatesUri", "instantiatesUri", str, True, None, False),
            ("location", "location", fhirreference.FHIRReference, False, None, False),
            ("note", "note", annotation.Annotation, True, None, False),
            ("outcome", "outcome", mii_codeableconcept.CodeableConcept, False, None, False),
            ("partOf", "partOf", fhirreference.FHIRReference, True, None, False),
            ("performedAge", "performedAge", age.Age, False, "performed", True),
            ("performedDateTime", "performedDateTime", fhirdate.FHIRDate, False, "performed", True),
            ("performedPeriod", "performedPeriod", mii_period.Period, False, "performed", True),
            ("performedRange", "performedRange", range.Range, False, "performed", True),
            ("performedString", "performedString", str, False, "performed", True),
            ...
            ("statusReason", "statusReason", mii_codeableconcept.CodeableConcept, False, None, False),
            ("subject", "subject", fhirreference.FHIRReference, False, None, True),
            ("usedCode", "usedCode", mii_codeableconcept.CodeableConcept, True, None, False),
...
class ProcedureFocalDevice(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("action", "action", mii_codeableconcept.CodeableConcept, False, None, False),
...
class ProcedurePerformer(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("function", "function", mii_codeableconcept.CodeableConcept, False, None, False),
