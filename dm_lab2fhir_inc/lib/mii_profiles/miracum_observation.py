...
class Observation(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("code", "code", miracum_codeableconcept.CodeableConcept, False, None, True),
            ...
            ("valueQuantity", "valueQuantity", miracum_quantity.Quantity, False, "value", False),
...
try:
    from . import codeableconcept, miracum_codeableconcept
except ImportError:
...
try:
    from . import quantity, miracum_quantity
except ImportError:
